...
import static solutions.plural.qoala.utils.HttpStatusCode.*;

/**
 * Contains the values of status codes defined for HTTP.
 */
@IntDef({Continue, SwitchingProtocols, OK, Created, Accepted, NonAuthoritativeInformation, NoContent,
        ResetContent, PartialContent, MultipleChoices, /*Ambiguous, MovedPermanently,*/ Moved, Found,
        /*Redirect, SeeOther,*/ RedirectMethod, NotModified, UseProxy, Unused, /*TemporaryRedirect,*/
        RedirectKeepVerb, BadRequest, Unauthorized, PaymentRequired, Forbidden, NotFound,
        MethodNotAllowed, NotAcceptable, ProxyAuthenticationRequired, RequestTimeout, Conflict, Gone,
